...
describe('the mode function', function () {
  test('it returns a function', function () {
    expect((0, _mode.mode)(_identity2.default, _identity2.default)).toBeInstanceOf(Function);
  });
});

describe('the identity number mode operating on numbers', function () {
  const identityNumberMode = (0, _mode.numberMode)(_identity2.default);
...
test('modal number of vowels in an array of strings', function () {
  ...
  const modalNumberOfVowels = (0, _mode.numberMode)(numberOfVowels);
